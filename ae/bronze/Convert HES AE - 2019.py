...
csv_schema = StructType(
    [
        StructField("person_id_deid", StringType(), False),
        ...
        StructField("aekey", IntegerType(), True),
        StructField("aekey_flag", StringType(), True),
        ...
        StructField("depdur", IntegerTypeType(), True),
        StructField("deptime", IntegerTypeType(), True),
